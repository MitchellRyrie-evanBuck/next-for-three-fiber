...
import { Instances, Computers } from './src/Computers'

export default function App() {

  return (
    <div className='' style={{ height: '666px' }} >
    <Canvas className='h-hull' shadows dpr={[1, 1.5]} camera={{ position: [-1.5, 1, 5.5], fov: 45, near: 1, far: 20 }}  eventPrefix="client">
      {/* Lights */}
