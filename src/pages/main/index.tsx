      ...
      <div
        ...
        <div className='flex px-6'>
          <div className='w-1/2  flex flex-row flex-col items-center justify-center px-24'>
            <div className={`text-center text-black dark:text-white font-600 text-2xl best ${styles.introduce}`}>
              My name is Mitchell Ryrie, and I am a web developer who enjoys exploring unknown fields.
            </div>
            <div className={`best text-center text-black dark:text-white font-600 text-2xl ${styles.introduce}`}>
            ...
            <motion.button
              ...
              hover:bg-[rgba(61,61,61,0.9)] px-8 py-2 bg-[#000000] dark:bg-white rounded-full 
              text-white dark:text-black font-light transition duration-200 ease-linear">
              Browse Template
            </motion.button>
          </div>
